...
import com.blackdog.dictation_teacher.models.retify.Help;
import com.blackdog.dictation_teacher.models.retify.PnuErrorWord;
import com.blackdog.dictation_teacher.models.retify.PnuErrorWordList;
...
public class ExamResultDetailedPage extends AppCompatActivity {
    ...
    private static final String TAG = "ExamResultDetailedPage";

    QuestionResult questionResult;
    String question;
    String correctAnswer = "";

    @BindView(R.id.tvTable1)
    TextView tvTable1;
    @BindView(R.id.tvTable2)
    TextView tvTable2;
    @BindView(R.id.tvTable3)
    TextView tvTable3;
    @BindView(R.id.tvStudentAnswer)
    TextView tvStudentAnswer;
    @BindView(R.id.tvCorrectAnswer)
    TextView tvCorrectAnswer;
    @BindView(R.id.tvCandWord)
    TextView tvCandWord;
    @BindView(R.id.ivRedCircle)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (questionResult == null || question == null) {
            return;
        }
        ...
        tvCorrectAnswer.setText(question);
